...
def monitor_reward(agent_states: AgentStates, profit_info: dict, reward_monitor: dict) -> None:
    selling_price      = agent_states["selling_price"]
    procurement_cost   = agent_states["procurement_cost"]
    sale               = agent_states["sale"]
    excess             = agent_states["excess"]
    ...
    reward1      = income - outcome - order_cost - holding_cost - backlog
    reward2      = profit - excess - order_cost - holding_cost - backlog

    reward_monitor['income'].append(income)
    reward_monitor['outcome'].append(- outcome)
    reward_monitor['order_cost_reward'].append(- order_cost)
    reward_monitor['holding_cost'].append(- holding_cost)
    reward_monitor['profit'].append(profit)
    reward_monitor['excess_reward'].append(- excess)
    reward_monitor['backlog'].append(- backlog)
    reward_monitor['reward1'].append(reward1)
    reward_monitor['reward2'].append(reward2)
